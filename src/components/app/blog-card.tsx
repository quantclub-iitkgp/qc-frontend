...
export function BlogCard({ blog, featured = false }: BlogCardProps) {
  ...
  if (featured) {
    return (
      <Link href={`/blogs/${slug}`} className="block group">
        <article className="flex flex-col md:flex-row border-4 border-border bg-secondary-background shadow-shadow hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none transition-all overflow-hidden">
          {blog.coverImage && (
          ...
          <div className="flex flex-col justify-between p-8 flex-1">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-foreground/60 mt-6 pt-4 border-t-2 border-border/20">
              {blog.author && (
  ...
  return (
    <Link href={`/blogs/${slug}`} className="block group h-full">
      <article className="h-full flex flex-col border-4 border-border bg-secondary-background shadow-shadow hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none transition-all overflow-hidden">
        {blog.coverImage && (
        ...
        <div className="flex flex-col flex-1 p-5">
          ...
          <div className="flex flex-wrap items-center gap-3 text-xs text-foreground/60 mt-4 pt-4 border-t-2 border-border/20">
            {blog.author && (
