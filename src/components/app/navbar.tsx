    ...
    <nav className="fixed left-0 top-0 z-20 mx-auto flex h-[70px] w-full items-center border-b-4 border-border bg-secondary-background px-5">
      <div className="mx-auto flex w-[1300px] text-foreground max-w-full items-center justify-between">
        <div className="flex items-center xl:gap-10 gap-10">
            ...
            /> */}
            <Link
            className="text-[22px] px-4 h-8 rounded-base flex bg-main text-main-foreground border-2 border-black items-center justify-center font-heading font-bold text-lg gap-2"
            href={"/"}
            >
        ...
        <div className="hidden lg:flex flex-1 items-center justify-center text-base font-base gap-10 xl:gap-10">
          <Link href="/docs/Introduction">Blogs</Link>
